...
var status = 1 #Variável que define o status do jogo, se o mesmo está parado ou rodando.
var vscore = 0 #Variável que define a pontuação do jogo.
var x = 2.75 #Variável que determina a velocidade do objeto(cenário) horizontalmente.
var y = 1.75 #Variável que determina a velocidade de queda do objeto(dragão). Puxa o dragão para baixo.
